...
public class frmChatTcp extends javax.swing.JFrame implements Runnable {
    public frmChatTcp() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmChatTcp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
